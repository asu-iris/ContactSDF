...
from cost.ball_foambrick.cost_three_ball_foambrick import Cost
...
class Parameters:
    def __init__(self):
        ...
        #      mode setting groups
        # ---------------------------------------------------------------------------------------------
        self.simulator_mode_ = 'balls_foambrick'
        ...
        # ---------------------------------------------------------------------------------------------
        self.model_path_ = 'env/xml/planning_mujoco_point_foambrick_env.xml'
        ...
        self.target_p_list_ = []
        self.target_p_list_.append(np.array([.05, -0.05, 0.02]))
        self.target_p_list_.append(np.array([-.05, 0.05, 0.02]))
        ...
        fts_q_ub = np.array([1, 1, 1, 1, 1, 1, 1, 1, 1])
