        ...
        for task_q in param.target_q_list_:
            ...
            while step_counter < 50:
                if not simulator.dyn_paused_:
                    ...
                    target_loss = param.planning_cost_.final_cost_fn(simulator.getPositionState(), np.hstack((task_p, task_q))).toarray().squeeze()
                    accumulated_trans_loss += target_loss
                    accumulated_rotation_loss += target_loss
